...
![image-20231017095934058](image/计算机操作系统(spongehah).assets/image-20231017095934058.png)

#### 2.4.1 基本分页存储管理

##### 1.1）页框和页面的概念

![image-20231017082840352](image/计算机操作系统(spongehah).assets/image-20231017082840352.png)
...
![image-20231017083132372](image/计算机操作系统(spongehah).assets/image-20231017083132372.png)
...
![image-20231017083616105](image/计算机操作系统(spongehah).assets/image-20231017083616105.png)

![image-20231017084238866](image/计算机操作系统(spongehah).assets/image-20231017084238866.png)
...
![image-20231017094012531](image/计算机操作系统(spongehah).assets/image-20231017094012531.png)
...
![image-20231017085451465](image/计算机操作系统(spongehah).assets/image-20231017085451465.png)

> 这是连续分配时逻辑地址到物理地址的转换方式：动态重定位，不清楚的可以去前面回顾一下

![image-20231017085650756](image/计算机操作系统(spongehah).assets/image-20231017085650756.png)

> 逻辑地址A对应的**物理地址**=P号页面在内存中的**起始地址**+**页内偏移量W**

![image-20231017090238089](image/计算机操作系统(spongehah).assets/image-20231017090238089.png)

![image-20231017092051442](image/计算机操作系统(spongehah).assets/image-20231017092051442.png)

![image-20231017092244116](image/计算机操作系统(spongehah).assets/image-20231017092244116.png)

![image-20231017092305141](image/计算机操作系统(spongehah).assets/image-20231017092305141.png)
...
![image-20231017094024655](image/计算机操作系统(spongehah).assets/image-20231017094024655.png)
...
注意：**页面大小是2的整数幂**
设页面大小为L,逻辑地址A到物理地址E的变换过程如下：![image-20231026170649057](image/计算机操作系统(spongehah).assets/image-20231026170649057.png)
...
>
> ![image-20231026171021929](image/计算机操作系统(spongehah).assets/image-20231026171021929.png)

**注意：虽然前面经过计算，一个页表项只需要3B就够了，可是为了方便页表的查询，往往会让每个页表项站内据4B，**
**如下：**

![image-20231026171320973](image/计算机操作系统(spongehah).assets/image-20231026171320973.png)

**另外：进程的页表通常是装在连续的内存块中的**

小总结：

![image-20231026171411763](image/计算机操作系统(spongehah).assets/image-20231026171411763.png)



##### 3）具有快表的地址变换机构

![image-20231026171430792](image/计算机操作系统(spongehah).assets/image-20231026171430792.png)

![image-20231026171456108](image/计算机操作系统(spongehah).assets/image-20231026171456108.png)

![image-20231026171526495](image/计算机操作系统(spongehah).assets/image-20231026171526495.png)
...
![image-20231026171833711](image/计算机操作系统(spongehah).assets/image-20231026171833711.png)
...
![image-20231026172006641](image/计算机操作系统(spongehah).assets/image-20231026172006641.png)

![image-20231026172019016](image/计算机操作系统(spongehah).assets/image-20231026172019016.png)



##### 4）两级页表

![image-20231026172107918](image/计算机操作系统(spongehah).assets/image-20231026172107918.png)

![image-20231026172156732](image/计算机操作系统(spongehah).assets/image-20231026172156732.png)

> **一级页表需要的连续内存块太多了**
>
> 根据局部性原理可知，很多时候，**进程在一段时间内只需要访问某几个页面就可以正常运行了**。因此**没有必要让整个页表都常驻内存。**

![image-20231026172428966](image/计算机操作系统(spongehah).assets/image-20231026172428966.png)

![image-20231026172818723](image/计算机操作系统(spongehah).assets/image-20231026172818723.png)

> 页面大小4KB,每个页表项4B,**每个页面可存放1K个页表项**，因此每1K个连续的页表项为一组，**每组刚好占一个内存块**，再讲各组离散地放到各个内存块中

![image-20231026172524242](image/计算机操作系统(spongehah).assets/image-20231026172524242.png)

![image-20231026172713329](image/计算机操作系统(spongehah).assets/image-20231026172713329.png)



![image-20231026172744036](image/计算机操作系统(spongehah).assets/image-20231026172744036.png)

![image-20231026172933562](image/计算机操作系统(spongehah).assets/image-20231026172933562.png)

> 1 各级页表的大小不能超过一个页面
> 2 n级页表需要n+1次访存（没有快表的情况下）

![image-20231026173111152](image/计算机操作系统(spongehah).assets/image-20231026173111152.png)



#### 2.4.2 基本分段存储管理

![image-20231026173213677](image/计算机操作系统(spongehah).assets/image-20231026173213677.png)

##### 1）什么是分段

![image-20231026192340436](image/计算机操作系统(spongehah).assets/image-20231026192340436.png)

![image-20231026192349253](image/计算机操作系统(spongehah).assets/image-20231026192349253.png)

##### 2）段表和地址变换

![image-20231026192405340](image/计算机操作系统(spongehah).assets/image-20231026192405340.png)

> 段表的每个段表项占6B：段长16位+基址32位=48bit=6B

![image-20231026192424211](image/计算机操作系统(spongehah).assets/image-20231026192424211.png)

![image-20231026192638876](image/计算机操作系统(spongehah).assets/image-20231026192638876.png)

##### 3）分段、分页管理的对比

![image-20231026192645373](image/计算机操作系统(spongehah).assets/image-20231026192645373.png)
...
![image-20231026192829590](image/计算机操作系统(spongehah).assets/image-20231026192829590.png)

> **分段**比分页**更容易实现信息的共享和保护**，只需指向同一个内存段即可

![image-20231026192959000](image/计算机操作系统(spongehah).assets/image-20231026192959000.png)
...
![image-20231026193549588](image/计算机操作系统(spongehah).assets/image-20231026193549588.png)



##### 4）分页分段的优缺点

![image-20231026193630785](image/计算机操作系统(spongehah).assets/image-20231026193630785.png)
...
![image-20231026193832906](image/计算机操作系统(spongehah).assets/image-20231026193832906.png)

> 先分段再分页

![image-20231026193844085](image/计算机操作系统(spongehah).assets/image-20231026193844085.png)

> 若是32位逻辑地址，每个段最多有2^4^=16个页

![image-20231026193852006](image/计算机操作系统(spongehah).assets/image-20231026193852006.png)

![image-20231026193858195](image/计算机操作系统(spongehah).assets/image-20231026193858195.png)

> 需要**三次访存**，比纯分页或纯分段**多一次**访存

![image-20231026193903986](image/计算机操作系统(spongehah).assets/image-20231026193903986.png)
...
![image-20231026195753311](image/计算机操作系统(spongehah).assets/image-20231026195753311.png)

##### 1）传统存储管理方式的特征、缺点

![image-20231026194418031](image/计算机操作系统(spongehah).assets/image-20231026194418031.png)
...
比如这个程序：<img src="image/计算机操作系统(spongehah).assets/image-20231026194854319.png" alt="image-20231026194854319" style="zoom:50%;" />这个程序，while循环内的代码拥有时间局部性，a数组具有空间局部性



##### 3）虚拟内存的定义和特征

![image-20231026195017771](image/计算机操作系统(spongehah).assets/image-20231026195017771.png)
...
![image-20231026195606971](image/计算机操作系统(spongehah).assets/image-20231026195606971.png)



![image-20231026195642633](image/计算机操作系统(spongehah).assets/image-20231026195642633.png)



#### 2.5.2 请求分页管理方式

![image-20231026200623599](image/计算机操作系统(spongehah).assets/image-20231026200623599.png)

##### 1）页表机制

![image-20231026200648139](image/计算机操作系统(spongehah).assets/image-20231026200648139.png)
...
![image-20231026200908264](image/计算机操作系统(spongehah).assets/image-20231026200908264.png)
![image-20231026200915383](image/计算机操作系统(spongehah).assets/image-20231026200915383.png)
...
![image-20231026201102049](image/计算机操作系统(spongehah).assets/image-20231026201102049.png)

![image-20231026201241798](image/计算机操作系统(spongehah).assets/image-20231026201241798.png)

![image-20231026201307873](image/计算机操作系统(spongehah).assets/image-20231026201307873.png)
...
![image-20231026201514768](image/计算机操作系统(spongehah).assets/image-20231026201514768.png)
...
![image-20231107084948915](image/计算机操作系统(spongehah).assets/image-20231107084948915.png)



##### 1）最佳置换算法OPT

![image-20231107085254670](image/计算机操作系统(spongehah).assets/image-20231107085254670.png)
...
![image-20231107090012863](image/计算机操作系统(spongehah).assets/image-20231107090012863.png)
![image-20231107090156477](image/计算机操作系统(spongehah).assets/image-20231107090156477.png)

> 维护了一个队列，每次发生缺页中断时，将队首的页面换出内存，换入的新页面放到队尾
>
> Belady异常：当为进程分配的物理块数增大时，缺页次数不减反增的异常现象。
>
> **只有FIFO算法会产生Belady异常，算法性能查**



##### 3）最近最久未使用算法LRU

![image-20231107090534070](image/计算机操作系统(spongehah).assets/image-20231107090534070.png)
...
![image-20231107091446250](image/计算机操作系统(spongehah).assets/image-20231107091446250.png)
...
![image-20231107092709865](image/计算机操作系统(spongehah).assets/image-20231107092709865.png)
...
![image-20231107093051666](image/计算机操作系统(spongehah).assets/image-20231107093051666.png)



#### 2.5.4 页面分配策略、抖动、工作集

![image-20231107093526933](image/计算机操作系统(spongehah).assets/image-20231107093526933.png)
